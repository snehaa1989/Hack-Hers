            ...
            children: <Widget>[
              ...
              Expanded(
                child: GridView.count(crossAxisCount: 2,
                  ...
                  children: <Widget>[
                    categoryWidget('dietgirl', "Breakfast",kbreak),
                    categoryWidget('dietgirl', "Lunch",klunch),
                    categoryWidget('dietgirl', "Snacks",ksnack),
                    categoryWidget('dietgirl', "Dinner",kdinner),
                  ],
                ),
              ),
              Container(
