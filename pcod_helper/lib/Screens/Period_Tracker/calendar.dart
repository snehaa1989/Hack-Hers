...
import 'package:pcod_helper/Screens/Period_Tracker/calendar_model.dart';
...
class _CalendarState extends State<Calendar> {
  ...
  void _onDaySelected(DateTime day, List events,List p) {
    setState(() {
      _selectedDay = day;
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("Log Period", style: GoogleFonts.montserrat(
                      color: Color.fromRGBO(59, 57, 60, 1),
                      fontSize: 18,
                      fontWeight: FontWeight.bold)),
    ...
    return Container(
        ...
        child: TableCalendar(
          ...
          calendarStyle: CalendarStyle(
            ...
            todayStyle: TextStyle(color: Colors.pinkAccent, fontSize: 15, fontWeight: FontWeight.bold),
  ...
  Widget eventTitle(){
    if(_selectedEvents.length == 0){
      return Container(
        ...
        child:Text("No Period Logged", style: Theme.of(context).primaryTextTheme.headline1),
      );
    }
    return Container(
      padding: EdgeInsets.fromLTRB(15, 20, 15, 15),
      child:Text("Cycles", style: Theme.of(context).primaryTextTheme.headline1),
    );
  }
        ...
        children: <Widget>[
          Container(
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
              ...
              Text("Period Tracker", style: Theme.of(context).primaryTextTheme.headline1),
